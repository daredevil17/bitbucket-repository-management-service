...
func NewToDoServiceServer(db *sql.DB) service.ToDoServiceServer {
...
func (s *toDoServiceServer) Create(ctx context.Context, req *domain.CreateRequest) (*domain.CreateResponse, error) {
...
// Read todo task
func (s *toDoServiceServer) Read(ctx context.Context, req *domain.ReadRequest) (*domain.ReadResponse, error) {
	// check if the API version requested by client is supported by server
	if err := s.checkAPI(req.Api); err != nil {
		return nil, err
	}
...
// Update todo task
func (s *toDoServiceServer) Update(ctx context.Context, req *domain.UpdateRequest) (*domain.UpdateResponse, error) {
	// check if the API version requested by client is supported by server
	if err := s.checkAPI(req.Api); err != nil {
		return nil, err
	}
...
// Delete todo task
func (s *toDoServiceServer) Delete(ctx context.Context, req *domain.DeleteRequest) (*domain.DeleteResponse, error) {
	// check if the API version requested by client is supported by server
	if err := s.checkAPI(req.Api); err != nil {
		return nil, err
	}
...
// Read all todo tasks
func (s *toDoServiceServer) ReadAll(ctx context.Context, req *domain.ReadAllRequest) (*domain.ReadAllResponse, error) {
	// check if the API version requested by client is supported by server
	if err := s.checkAPI(req.Api); err != nil {
		return nil, err
	}
